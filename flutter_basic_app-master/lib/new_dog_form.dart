...
class _AddDogFormPageState extends State<AddDogFormPage> {
  ...
  TextEditingController urlimage = new TextEditingController();

  void submitPup(BuildContext context) {
    if (nameController.text.isEmpty) {
      Scaffold.of(context).showSnackBar(new SnackBar(
        backgroundColor: Colors.redAccent,
        content: new Text('Peaky Blinders neeed names!'),
      ));
    } else {
      var newDog = new Dog(nameController.text, locationController.text,
          descriptionController.text, urlimage.text);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text('Add a new Peaky Blinder'),
              ...
              child: new Builder(
                builder: (context) {
                  return new RaisedButton(
                    ...
                    color: Colors.red,
                    child: new Text('Submit Peaky Blinder'),
                  );
                },
              ),
            )
